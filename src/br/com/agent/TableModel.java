...
public class TableModel extends AbstractTableModel {
	...
	private List<QualityAttributeClass> rows = new ArrayList<QualityAttributeClass>(100);

	/* Array de Strings com o nome das colunas. */
	private String[] columns = new String[] { "Classe", "Arquivo", "Reusabilidade", "Manutenção", "Legibilidade"};

	public TableModel() {
		rows = new ArrayList<QualityAttributeClass>(100);
	}
