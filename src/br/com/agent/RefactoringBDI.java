...
public class RefactoringBDI {
	...
	public void body() {
		try {
			...
			logSystem.saveContent("Severe - Error caused by (Agent): " + ex.getMessage() + " in file: "
					+ fileAnalyzed.getAbsolutePath());
			throw new IllegalStateException(
					"Error caused by (Agent): " + ex.getMessage() + " in file: " + fileAnalyzed.getAbsolutePath());
		}
